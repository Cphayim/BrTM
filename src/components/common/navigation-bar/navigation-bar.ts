...
import { ConverHelper } from 'libs/helper'
...
@comify()
export default class NavigationBarComponent extends MyComponent {
  ...
  _setComponentStyle() {
    ...
    this.setDataSmart({ componentStyle: ConverHelper.obj2StyleStr(style) })
  }
  ...
  _setStatusBarStyle() {
    ...
    this.setDataSmart({ statusBarStyle: ConverHelper.obj2StyleStr(style) })
  }
  ...
  _setNavigationBarStyle() {
    ...
    this.setDataSmart({ navigationBarStyle: ConverHelper.obj2StyleStr(style) })
  }
